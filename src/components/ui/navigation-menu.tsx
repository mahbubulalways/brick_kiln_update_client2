...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-44 data-[motion=from-start]:slide-in-from-left-44 data-[motion=to-end]:slide-out-to-right-44 data-[motion=to-start]:slide-out-to-left-44 top-0 left-0 w-full p-2 pr-2.5 md:absolute md:w-auto",
