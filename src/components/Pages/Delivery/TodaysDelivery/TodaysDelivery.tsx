...
import { TDeliveryResponse, TDeliveryStatus } from "@/interface/delivery";
...
const TodaysDeliveryPage = ({ limit, page }: TQuery) => {
  ...
  return (
    <div className="rounded-md border bg-white shadow">
                      ...
                      <td className="border p-2">
                        <DropdownMenu>
                          ...
                          >
                            ...
                            <DropdownMenuItem>
                              <Link
                                href={`/dashboard/customer/profile/${row?.invoice?.customer?.customerCode}`}
                              >
                                <CustomDropDownMenuItem
                                  Icon={User}
                                  title="প্রোফাইলে যান"
      ...
      <CommonPrint ref={printRef} title="deliveries">
        <DeliveryPrint
