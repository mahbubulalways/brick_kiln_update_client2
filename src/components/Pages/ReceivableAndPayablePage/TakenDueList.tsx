            ...
            <div className="w-full overflow-hidden rounded-md border border-gray-200">
                ...
                {dues.length > 0 ? (
                    dues.map((item) => (
                        <div
                            key={item.id}
                            className="grid min-h-[70px] grid-cols-[minmax(0,1fr)_minmax(100px,180px)_minmax(100px,180px)_50px] items-center border-t border-gray-200 sm:min-h-[82px]"
                        >
                            {/* User Info + Amounts */}
                            <Link
                                href={`/dashboard/loan/profile/${item.id}`}
                                className="col-span-3 grid min-h-[70px] grid-cols-[minmax(0,1fr)_minmax(100px,180px)_minmax(100px,180px)] items-center transition hover:bg-gray-50 sm:min-h-[82px]"
                            >
                                {/* Name + Address */}
