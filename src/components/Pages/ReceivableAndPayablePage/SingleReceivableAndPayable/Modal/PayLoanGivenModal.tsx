          ...
          isError ? <CustomStatus type="error" /> :
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="flex flex-col gap-3">
                ...
                <CustomInput
                  name="amount"
                  label="টাকা ফেরত পেলাম"
                  placeholder="টাকা ফেরত পেলাম"
                  register={register}
                  type="number"
                />
                ...
                <CustomTextArea
                  name="description"
                  register={register}
                  placeholder="টাকা পাওয়ার সময়ের কিছু বর্ণনা লিখে রাখুন যা পরবর্তিতে আপনাকে মনে করিয়ে দিতে সাহায্য করবে"
                  label="বর্ণনা"
                />
              </div>
...
export default PayLoanGivenModal;