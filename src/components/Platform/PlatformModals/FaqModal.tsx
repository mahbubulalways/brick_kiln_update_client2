...
import { useCreateFaqApiMutation } from "@/redux/system.features/system.faq.features";
...
const FaqModal = ({ isOpen, onClose }: TFaqModal) => {
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex w-full items-center justify-between gap-2 pt-5">
                    ...
                    >
                        {isCreateLoading ? "সংরক্ষণ" : "সংরক্ষণ করুন"}
                    </button>
                </div>
            </form>
        </CustomModal>
